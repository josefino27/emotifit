...
<div class="row">
    <div class="col-12">
        <div class="form-group">
            <label for="">Nombre Emocion</label>
            <input type="text" class="form-control" name="nombre_emocion"
                value="{{ isset($emocion) ? $emocion->nombre_emocion : old('nombre_emocion') }}" required>
        </div>
    </div>
    {{-- <div class="col-12">
        <div class="form-group">
